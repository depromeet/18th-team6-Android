    ...
    override fun instance(config: Config): RuleSet =
        RuleSet(
            ...
            listOf(
                ...
                RemoteDataSourceImplementationVisibility(config),
                RepositoryImplementationVisibility(config),
                RepositoryReturnTypeContract(config),
                RepositoryResultRunCatchingContract(config),
