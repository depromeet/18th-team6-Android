...
- OBRit은 Android Compose 앱을 포함한 Kotlin Multiplatform 프로젝트다. iOS 구현 지침은 `ios-CLAUDE.md`를 따른다.
...
- 각 요소를 구현하거나 수정하기 전에 [docs/ruleset/README.md](docs/ruleset/README.md)에서 해당 convention 문서를 먼저 확인한다.
...
- platform-specific KMP 구현은 알맞은 source set에 둔다. iOS source set 규칙은 `ios-CLAUDE.md`를 따른다.
