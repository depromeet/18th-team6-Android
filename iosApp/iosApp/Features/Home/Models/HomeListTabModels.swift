...
enum HomeListTabSampleData {
    static let items: [HomeListTabItem] = {
        let seedItems = [
            SeedItem("칫솔", 30, 0, -1, .l1, "home_orb_toothbrush"),
            SeedItem("면도기 날", 18, 0, 2, .l2, "home_orb_razor"),
            SeedItem("수세미", 30, 0, 0, .l3, "home_orb_sponge"),
            SeedItem("샤워기 필터", 82, 1, 8, .l4, "home_orb_shower_filter"),
            SeedItem("세탁 세제", 20, 1, 10, .l4, "home_orb_detergent"),
            SeedItem("수건", 26, 4, 14, .l5, "home_orb_towel"),
            SeedItem("디퓨저", 82, 2, 18, .l5, "home_orb_diffuser"),
            SeedItem("지퍼백", 15, 5, 24, .l6, "home_orb_sponge"),
            SeedItem("키친타월", 8, 2, 28, .l6, "home_orb_towel"),
            SeedItem("바디워시", 12, 1, 32, .l6, "home_orb_diffuser")
        ]
